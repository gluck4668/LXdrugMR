...
odds_ratios <- function (or_mr) {
                ...
                or_mr$Reciprocal_OR <- 1/exp(or_mr$b)
                or_mr$Reciprocal_OR_lci95 <- or_mr$Reciprocal_OR - 1.96 * or_mr$se
                or_mr$Reciprocal_OR_uci95 <- or_mr$Reciprocal_OR + 1.96 * or_mr$se
          return(or_mr)}
